...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 text-muted">
            Log in to continue building your startup.
          </p>
          ...
          <div className="my-6 flex items-center gap-3">
            <div className="h-px flex-1 bg-primary-100/50" />
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-center lg:bg-gradient-to-br lg:from-primary/5 lg:via-background lg:to-primary-200/10">
        <div className="max-w-md text-center">
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-primary shadow-glow">
          ...
          <p className="mt-3 text-muted">
            AI-powered startup planning for the next generation of founders.
          </p>
        </div>
      </div>
    </div>
